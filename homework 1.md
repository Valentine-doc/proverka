...
## 9 Создание веток
 Для создания branch (ветки) нам необходимо использовать следующую команду: _git branch name_branch_. Можно создавать много и больше веток, сколько необходимо.